...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "climatechangecryptodollars " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"climatechangecryptodollarstools.com", "dnsseed.climatechangecryptodollarstools.com"},
    {"climatechangecryptodollarspool.org", "dnsseed.climatechangecryptodollarspool.org"},
    {"xurious.com", "dnsseed.qwe.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"climatechangecryptodollarstools.com", "testnet-seed.climatechangecryptodollarstools.com"},
    {"xurious.com", "testnet-seed.qwe.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. climatechangecryptodollars is probably already running."), addrBind.ToString().c_str());
        else
